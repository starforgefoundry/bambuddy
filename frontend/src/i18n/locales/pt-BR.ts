export default {
  ...
  printers: {
    ...
    acceptedModels: {
      label: 'Também aceitar trabalhos de',
      help: 'Trabalhos na fila destinados a esses modelos podem ser executados nesta impressora. Apenas modelos com G-code intercambiável são oferecidos.',
    },
